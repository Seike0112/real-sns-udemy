        ...
        <div className="rightbarInfo">
          ...
          <div className="rightbarFollowings">
            <div className="rightbarFollowing">
              ...
              />
              <span className="rightbarFollowingName">Yamaki Kanata</span>
            </div>
            <div className="rightbarFollowing">
              <img 
                ...
                className="rightbarFollowingImg"
              />
              <span className="rightbarFollowingName">Ito Kanata</span>
            </div>
            <div className="rightbarFollowing">
              <img 
                ...
                className="rightbarFollowingImg"
              />
              <span className="rightbarFollowingName">Tatibana Kanata</span>
            </div>
            <div className="rightbarFollowing">
              <img 
                ...
                className="rightbarFollowingImg"
              />
              <span className="rightbarFollowingName">Koike Kanata</span>
            </div>
          </div>
        </div>
      </>
